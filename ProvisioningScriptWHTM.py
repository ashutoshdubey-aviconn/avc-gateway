...
def main():
    ...
    while start:
        ...
        print("5. Add meter configurations")
        ...
        if options == 0:
            ...
            multiple_meter_conf = 1
            while multiple_meter_conf:
                print("inside meter configurations")
                meter_id = int(input("Enter Meter id : "))
                print("1. Select 1 if you want to use as single source")
                print("2. Select 2 if you want to use as dual source")
                source_option = int(input("select options from above : "))
                if source_option == 1:
                    print("0. For mains supply select 0")
                    print("1. For dg 1 supply select 1")
                    ...
                    print("wrong option")
                print("1. If you want to add meter conf of another meter select 1")
                print("2. Select 2 for quit")
                x = int(input("Select your choices : "))
                if x == 2:
        ...
        elif options == 8:  # for network-manager configuration
