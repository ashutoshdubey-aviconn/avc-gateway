"""
Module wareApp.energy.meter (migrated)
"""
...
from wareApp.constants.topics import consumption_state_topic
...
from wareApp.utils.helpers import publish_status
from wareApp.utils.payload import build_consumption_payload
...
def handle_meter_energy(
    ...
    from wareApp.utils.helpers import get_home_gateway_hgw_id
