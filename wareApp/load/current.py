...
from wareApp.utils.helpers import update_phase_entry
...
def handle_current_message(client: mqtt.Client, msg: mqtt.MQTTMessage, site: Site, msg_type: list[str]) -> bool:
    return _handle_phase(client, msg, site, msg_type, "current", "3")
