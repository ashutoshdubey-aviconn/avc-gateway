"""
Migrated load.wattage to wareApp.load.wattage
"""
...
from wareApp.constants.topics import load_data_state_topic
from wareApp.models import LoadData, Site, SiteLoadPower
from wareApp.utils.payload import build_wattage_load_message
