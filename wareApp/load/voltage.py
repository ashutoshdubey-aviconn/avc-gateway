...
def handle_voltage_message(client: mqtt.Client, msg: mqtt.MQTTMessage, site: Site, msg_type: list[str]) -> bool:
    return _handle_phase(client, msg, site, msg_type, "volt", "2")
