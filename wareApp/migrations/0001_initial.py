    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('power_source', models.PositiveIntegerField(choices=[(0, 'MAINS SUPPLY'), (1, 'DG 1'), (2, 'DG 2'), (3, 'DG 3'), (4, 'DG 4'), (5, 'DG 5')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='AisleInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_type', models.PositiveIntegerField(blank=True, choices=[(1, 'WH_Metering'), (2, 'WH_Energy_Saving'), (3, 'WH_AssetTracking')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_type', models.PositiveIntegerField(blank=True, choices=[(1, 'METER'), (2, 'SENSOR')], null=True)),
                ...
                ('associated_aisle_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='wareApp.AisleGroup')),
                ('associated_site', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='wareApp.Site')),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='wareApp.SmartEnergyDevices')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meter_number', models.PositiveIntegerField(blank=True, null=True)),
                ('power_source_1', models.PositiveIntegerField(blank=True, choices=[(0, 'Mains Supply'), (1, 'DG_1'), (2, 'DG_2'), (3, 'DG_3'), (4, 'DG_4'), (5, 'DG 5')], null=True)),
                ('power_source_2', models.PositiveIntegerField(blank=True, choices=[(0, 'Mains Supply'), (1, 'DG_1'), (2, 'DG_2'), (3, 'DG_3'), (4, 'DG_4'), (5, 'DG 5')], null=True)),
